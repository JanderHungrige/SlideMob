    ...
    def create_mapping(self, original_text_elements: set, original_text: str, 
        ...
        try:
            ...
            if self.model_type == "llama":
                prompt = mapping_prompt_llama2(original_text_elements, original_text, translated_text)
            elif self.model_type == "deepseek":
                prompt = mapping_prompt_deepseek(original_text_elements, original_text, translated_text)
            else:
